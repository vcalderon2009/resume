  ...
  \workResumeSubheading
    ...
    {Jan 2021 - Present}
      ...
      \workExperienceBullet{
        ...
        models using supervised deep learning and 6D point clouds of towers
        and mounted equipment. Reduced the processing time by 20\% over manual
        processing when identifying mounted equipment on the digital version
        of towers.
      }
      %
      \workExperienceBullet{
