...
\section{Work Experience}
  ...
  \workResumeSubheading
    ...
    {Jan 2020 - Present}
      ...
      \workExperienceBullet{
        ...
        and mounted equipment. Reduced the packaging time by 20\% over manual
        packaging.
      }
      %
      \workExperienceBullet{
  ...
  \workResumeSubheading
      ...
      %
        ...
        \workExperienceBullet{
          ...
          200 hospitals in the HCA network. Also responsible for the
          training, validation, deployment, and monitoring of the models.
        }
        %
        \workExperienceBullet{
          Led the initial planning and development of a risk prediction
          algorithm for early detection of Sepsis and organ failure using
          time-dependent features of the patient.
        }
      %
      \resumeItemListEnd
  % -------------- VANDERBILT
  \workResumeSubheading
      ...
      {PhD candidate in computational Astrophysics}
      {Jun 2017 - Aug 2019}
      % --- Description fo the work
      \resumeItemListStart
      % -- Machine learning
