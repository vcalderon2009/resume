...
\newcommand{\resumeSubHeadingListStart}{\begin{itemize}[leftmargin=*]\itemsep\itemseparation }
\newcommand{\resumeSubHeadingListStartDash}{\begin{itemize}[leftmargin=*, label={--}]\itemsep\itemseparation }
...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \textbf{\href{\mywebsite}{\Huge \myname}} &
  % -- Github
...
\section{Technical Skills}
 \resumeSubHeadingListStartDash
  % --- Programming skills
  \skillItem{Programming}{Python (pandas, sklearn, web scraping)}
